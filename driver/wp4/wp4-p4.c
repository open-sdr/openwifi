...
// Start of Pipeline
    accept:
    {
        ...
        u8 ID_ok_0;
        {
            ...
            {
                if ((headers.frameCtrl.subType == 0xb)) state_output_0 = state_update(2);
                if ((headers.frameCtrl.subType == 0x0)) state_output_0 = state_update(8);
                if ((headers.frameCtrl.subType == 0xa))
                {
                    ...
                    if (value >= 0) {
                        /* run action */
                        switch (value) {
                            case swtch_ID_BAD_action: 
                            {
                                ID_ok_0 = 0;
                            }
                            break;
                            case swtch_ID_GOOD_action: 
                            {
                                ID_ok_0 = 1;
                            }
                            break;
                            case swtch_lookup_tbl_NoAction: 
                            {
                    ...
                    if ((ID_ok_0 == 1)) state_output_0 = state_update(11);
                    if ((ID_ok_0 == 0)) state_output_0 = state_update(10);                    
                }
                ...
                if ((headers.frameCtrl.subType == 0xc))
                {
                    ...
                    if ((ID_ok_0 == 1)) state_output_0 = state_update(5);
                    if ((ID_ok_0 == 0)) state_output_0 = state_update(4);
                }


                if ((headers.frameCtrl.subType == 0x8))
                {
                    ssid_0 = ssid_check(p_uc_data, wp4_ul_size);
                    if ((ssid_0 == 1)) state_output_0 = state_update(6);
                    if ((ssid_0 == 0)) 
                    {
            ...
            if ((headers.frameCtrl.frameType == 0x1)) 
            {
                wp4out.output_action = PASS;
            }
            if ((headers.frameCtrl.frameType == 0x2))
            {
                wp4out.output_action = CPU;
                to_cpu(headers);
                state_output_0 = state_update(0);
            }
...
int wp4_table_lookup(struct swtch_lookup_tbl_key *key) {
    ...
    return swtch_lookup_tbl_NoAction;   // Return default action for a table miss
}

// Kernel module functions
EXPORT_SYMBOL_GPL(wp4_packet_in);
