...
sdrpi|[HexSDR](https://github.com/HexSDR/)Dual Ether,GPS,TCXO,RF_AP, in Rraspberry Pi size |Done|[32bit img](https://users.ugent.be/~xjiao/openwifi-1.3.1-wilsele-32bit.img.xz)|**NO** need
