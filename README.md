...
[[Download img and Quick start](#Download-img-and-Quick-start)] [[OpenWRT quick start](./doc/img_build_instruction/openwrt/openwrt.md#quick-start-openwifi-ap-using-prebuild-openwrt-image)] [[known issue](doc/known_issue/notter.md)] [[**Tips for Windows users**](https://github.com/open-sdr/openwifi/discussions/341)]
